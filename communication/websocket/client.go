...
type Client struct{
    ...
    DisconnectCallback func(*Client)
}
...
func NewClient (w *World, c *websocket.Conn, e chan bool, f func(*Client, []byte), d func(*Client)) (client *Client) {
    client = &Client{
        World: w,
        Conn: c,
